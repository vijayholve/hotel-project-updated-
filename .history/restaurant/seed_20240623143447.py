...
def send_mail_to_user_after_booking( pk):
    =orders.objects.get(id=pk)
    user = dish_obj.user
    Subject="Your Order Confirmation"

    body=fmessage = f"""
    Dear {orde.user.username},

    Thank you for your order with {o}! We are delighted to inform you that your dish, {dish_name}, has been successfully placed and is now being prepared with the utmost care and attention.
