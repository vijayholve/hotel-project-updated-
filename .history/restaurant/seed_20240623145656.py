...
def send_mail_to_user_after_booking( pk):
    ...
    Thank you for your order with {order_obj.restaurants.restaurantame}! We are delighted to inform you that your dish, {dish_name}, has been successfully placed and is now being prepared with the utmost care and attention.
