...
user
    body=fmessage = f"""
    Dear {orders.user.username},

    Thank you for your order with {or}! We are delighted to inform you that your dish, {dish_name}, has been successfully placed and is now being prepared with the utmost care and attention.
