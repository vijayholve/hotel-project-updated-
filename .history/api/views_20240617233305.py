...
from .serializable import serializer_restaurant,serializer_dish,User_Serializar,LoginSerializer
...
class UserAPI(APIView):
    def get(self,request):
        ...
        serailizer=User_Serializar(user=user,many=True)
        if serailizer.is_valid():
            return Response(serailizer.data)
        else:
            class ModelNameViewSet(viewsets.ReadOnlyModelViewSet):
