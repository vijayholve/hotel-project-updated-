...
def avalable_check(def FUNCTIONNAME_pre_init_receiver(sender, instance, *args, **kwargs):
    pass


pre_init.connect(FUNCTIONNAME_pre_init_receiver, sender=MODELNAME))
def booking_room(request, pk): 
    ...
    if request.method == "POST":
        ...
        if startdate and enddate:
            ...
            if avalable_check(request,start_datetime,end_datetime):
