...
class Room(models.Model):
    ...
    roomImage=models.ImageField(upload_to="roomImages/",default="C:\Users\Vijay\django_pro\hotels\media\roomImages\istockphoto-1125725514-170667a.webp",null=True,blank=True)
