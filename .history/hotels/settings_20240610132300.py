...
# Add the path to the py_pro directory to the system path
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../py_pro')))

# Import the variable from test.py
from test import reci

# Use the variable
print(my_variable)  # Output should be: Hello from test.py
