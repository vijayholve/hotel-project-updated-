...
result_backend = 'django-db'          # Updated key for result backend
accept_content = ['json']             # Updated key for accepted content types
task_serializer = 'json'              # Updated key for task serializer
result_serializer = 'json'            # Updated key for result serializer
timezone = 'UTC'   
