...
def user_rooms_data(request,userid):
    user=User.objects.get(id=userid)
    rooms=Booking.objects.filter(user=user).values("room")
    content={"rooms":rooms}
    return render(request,"C:\Users\Vijay\django_pro\hotels\templates\room\booking_data.html")
