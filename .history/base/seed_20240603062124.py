...
import random
from django.contrib.auth.models import I
...
def upload_image_in_restaurants():
    ...
    files=glob.glob(os.path.join(rf"C:\Is\Vijay\django_pro\hotels\media\restaurant_images","*"))
...
def register_i_to_send_mail(receiver_email,fullname):
    hotel_obj=hotel.objects.get(id=1)
...
def upload_images():
    ...
    director=rf"C:\Is\Vijay\django_pro\hotels\media\images"
