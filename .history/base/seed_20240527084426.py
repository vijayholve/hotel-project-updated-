...
def register_user_to_send_mail(receiver_email,hotel_):
    subject=f"Welcome to {hotel_name} – Your Account is Ready!"
    email_content = f"""
Subject: Welcome to {restaurant_name} – Your Account is Ready!

Dear {user_name},

Thank you for creating an account with {restaurant_name}! We're thrilled to have you join our community.
...
Visit us at {website_link} and start your culinary adventure today!
